...
/**
 * Dashboard del rol Empleado. Sin `.form`: layout a mano con MigLayout
 ...
 * viven en {@link com.tuerca.pos.controller.EmployeeDashboardController}.
 */
public class EmployeePanel extends JPanel {
    ...
    private final JPanel panelBotones = new JPanel(new GridLayout(3, 3, 20, 20));
    ...
    private final JButton btnVentas = new JButton("Ventas");
    ...
    private void initComponents() {
        ...
        lblTitulo.setFont(new Font("SF Pro Rounded", Font.BOLD, 36));
        lblTitulo.setHorizontalAlignment(SwingConstants.CENTER);

        lblSubtitulo.setFont(new Font("SF Pro Rounded", Font.BOLD, 36));
