...
/**
 * Formulario "Editar Producto" (FN.3). Sin `.form`: layout a mano con
 * MigLayout, mismo estilo visual que {@link NuevoProducto}. Los getters
 * devuelven {@code String} (antes devolvían el {@code JTextField}) para ser
 * consistentes con {@link NuevoProducto}; ver {@code prepararEdicion}/
 * {@code actualizarProducto} en {@link com.tuerca.pos.controller.ProductoController}.
 */
public class EditarProducto extends JPanel {

    private final JLabel lblTitulo = new JLabel("Editar producto");
    ...
    // Exponemos los datos (String, consistente con NuevoProducto)
    ...
    public void setCodigoField(String texto) { codigoField.setText(texto); }
    public void setDescripcionField(String texto) { descripcionField.setText(texto); }
    public void setDepartamentoField(String texto) { departamentoField.setText(texto); }
    public void setPrecioField(String texto) { precioField.setText(texto); }
    public void setStockField(String texto) { stockField.setText(texto); }
